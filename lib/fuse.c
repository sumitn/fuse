...
static void fuse_lib_write_read(fuse_req_t req, fuse_ino_t ino, 
...
static void fuse_lib_write(fuse_req_t req, fuse_ino_t ino, char *buf1,
			   size_t size, off_t off, struct fuse_file_info *fi)
{
   struct fuse *f = req_fuse_prepare(req);
   char *path, *buf = NULL;
...
static struct fuse_lowlevel_ops fuse_path_ops = {
   ...
   .write_read = fuse_lib_write_read,
